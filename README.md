...
| Gallery (`/[locale]/gallery`) | SSR | `force-dynamic`, filters via searchParams |
| Artwork Detail (`/[locale]/gallery/[slug]`) | ISR | `revalidate = 3600`, top 20 pre-rendered |
